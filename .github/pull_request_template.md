...
Ensure you have read over CONTRIBUTING - https://github.com/chocolatey/chocolatey-ansible/blob/master/CONTRIBUTING.md. We provide VERY defined guidance (as such, we strongly adhere to it).
